...
| `app.py` decomposition | Maint. | 🟡 Phases 0–4 + Calibrate All wizard done 2026-06-12 | app.py 4856→1801 ln; core/runtime/ui/camera/services packages, six controllers, command/event seam, main loop as tick stages, guided Calibrate All wizard as a second seam client ([DECOMPOSITION_PLAN.md](DECOMPOSITION_PLAN.md)). Next: operator quick smoke (Phase 4 + wizard); Phase 5 = tablet calibration client |
