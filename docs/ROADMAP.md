...
| `app.py` decomposition | Maint. | 🟡 Phases 0–4 done 2026-06-12 | app.py 4856→1801 ln; core/runtime/ui/camera/services packages, six controllers, command/event seam, main loop as tick stages in runtime/main_loop.py ([DECOMPOSITION_PLAN.md](DECOMPOSITION_PLAN.md)). Next: operator quick smoke over Phase 4, "Calibrate All" wizard; Phase 5 = tablet calibration client |
