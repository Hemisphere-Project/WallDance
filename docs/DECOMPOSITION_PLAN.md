...
- Next: operator §6.3 quick smoke over Phase 4 + a manual pass of the wizard flow (incl. live-rig servo phase); Phase 5 (tablet client) when wanted.
