...
- Operator wizard-flow pass ✅ 2026-06-12 (playback; the Calib1 exposure-servo phase only exercises on the IDS rig — re-check on the next rig day).
- 4 h cool-machine soak ✅ PASS 2026-06-13 (see Phase 4 entry) — **no decomposition debt remains**.
- Next: Phase 5 (tablet client) when wanted; wizard Calib1 servo phase re-check on the next rig day.
