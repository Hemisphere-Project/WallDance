...
| `app.py` decomposition | Maint. | ✅ Phases 0–4 done + operator-smoked 2026-06-12 | app.py 4856→1801 ln; core/runtime/ui/camera/services packages, six controllers, command/event seam, main loop as tick stages, guided Calibrate All wizard as a second seam client ([DECOMPOSITION_PLAN.md](DECOMPOSITION_PLAN.md)). Remaining: operator wizard-flow pass; Phase 5 = tablet calibration client (separate effort, unblocked) |
